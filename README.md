 找工作之余，对代码进行整理  
 本人十多年开发过程中积累了大量实战经验，这些开源项目就是实战总结出来的。  
 1、持续集成，尽量实现自动化运维。当实现高效的自动化运维时，系统才会更快的暴露出问题，进行升级迭代。   
 2、技术开发会像当初的互联网一样，当技术壁垒逐渐消失，项目整体的运作效率将成为关键。   
 3、微服务架构一般都是web项目配合docker使用。但任何项目中其实都可以用类似这种方式进行拆分。  
 4、如何以结果为导向，XX概念出来之前就应该已经在使用了，而不是进行跟风，甚至为了'XX'而XX。   
